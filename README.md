# 🚀 Provisioning resources for a 2-tier application using Terraform 

✨This repository is created to learn and deploy a 2-tier application on AWS using Terraform. 
